        ...
        if (IS_CONNECT) {
            myBinder.WriteSendData(new TaskCallback() {
                ...
                public List<byte[]> processDataBeforeSend() {
                    ...
                    list.add(DataForSendToPrinterTSC.sizeBymm(70, 30));
...
//      result.error("invalid_argument", "argumentsssss '"+BNAME+"' not found", null);
//      BNAME = 'Printer_C590'


//      String name = (String) mBluetoothAdapter.getName();
//      if(!name.isEmpty()){
//        result.error("invalid_argument", "argumentsssss '"+name+"' not found", null);
//      }else{
//        result.error("invalid_argument", "argumentsssss 'name' not found", null);
//      }
